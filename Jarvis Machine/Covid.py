...
def corona():
    class CoronaDB:
        ...
        def createWidgets(self):
            ...
            self.corona_label = ttk.Label(self.master, text='CORONA Virus Data Shower', style="LightText.TLabel", font=('helvetica', 20))
            ...
            self.corona_frame = ScrolledFrame(self.master, borderwidth = 4, width=700, height=325, bg='black')
    ...
    master.geometry('840x650+125+50')
